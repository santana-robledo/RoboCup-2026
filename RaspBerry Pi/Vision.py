...
KERNEL = np.ones((5, 5), np.uint8) #Crea una matriz de nxn de 1 para operaciones morfologicas
...
class BallTracker:
    ...
    def read(self):
        ...
        if best_c is not None:
            ...
            error_x = x - origin_x
            area_output = best_area

            # 🔥 CIRCULO VERDE ALREDEDOR DE LA PELOTA
        ...
        return found, error_x, area_output, debug, 0
